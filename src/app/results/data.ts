    ...
    categories: [
      {
        ...
        raceResults: [
          ...
          { position: 18, driverName: 'Vígh György', points: 0, gap: '-25 pt', positionChange: 0 },
          {
            position: 19,
            driverName: 'Kvasz Richárd',
            points: 0,
          ...
          { position: 20, driverName: 'Stók Pál', points: 0, gap: '-25 pt', positionChange: 0 },
          {
            position: 21,
            driverName: 'Zsigri Márton',
            points: 0,
          ...
          { position: 22, driverName: 'Nagy Patrik', points: 0, gap: '-25 pt', positionChange: 0 },
          { position: 23, driverName: 'Vígh Levente', points: 0, gap: '-25 pt', positionChange: 0 },
          { position: 24, driverName: 'Vincze Tibor', points: 0, gap: '-25 pt', positionChange: 0 },
          { position: 25, driverName: 'Stáhl Roland', points: 0, gap: '-25 pt', positionChange: 0 },
          { position: 26, driverName: 'Kozma Zoltán', points: 0, gap: '-25 pt', positionChange: 0 },
          {
            position: 27,
            driverName: 'Turcsán János',
            points: 0,
          ...
          { position: 28, driverName: 'Szabó Csaba', points: 0, gap: '-25 pt', positionChange: 0 },
          { position: 29, driverName: 'Borsy Zoltán', points: 0, gap: '-25 pt', positionChange: 0 },
          {
            position: 30,
            driverName: 'Mészáros Ákos',
            points: 0,
          ...
          { position: 33, driverName: 'Vas Lőrinc', points: 0, gap: '-25 pt', positionChange: 0 },
        ],
      },
      {
        categoryId: 'semipro',
        ...
        results: [
          ...
          { position: 13, driverName: 'Vincze Tibor', points: 0, entryOrder: 10 },
          { position: 14, driverName: 'Molnár Attila', points: 0, entryOrder: 10 },
          { position: 15, driverName: 'Szabó Csaba', points: 0, entryOrder: 10 },
          { position: 16, driverName: 'Turcsán János', points: 0, entryOrder: 10 },
          { position: 17, driverName: 'Szoták Mihály', points: 0, entryOrder: 10 },
          { position: 18, driverName: 'Dóró Soma', points: 0, entryOrder: 10 },
          { position: 19, driverName: 'Nagy Patrik', points: 0, entryOrder: 10 },
          { position: 20, driverName: 'Borsy Zoltán', points: 0, entryOrder: 10 },
          { position: 21, driverName: 'Kozma Zoltán', points: 0, entryOrder: 10 },
        ],
      },
      {
        categoryId: 'junior',
      ...
      },
      {
        ...
        results: [
          ...
          { position: 3, driverName: 'Vígh György', points: 5, entryOrder: 4 },
          { position: 4, driverName: 'Stáhl Roland', points: 4, entryOrder: 5 },
          { position: 5, driverName: 'Vígh Levente', points: 6, entryOrder: 6 },
